...
import {
  ArrowRight, BarChart3, CheckCircle2, Database, FileCheck2, FileClock,
  FileDown, FileUp, FolderOpen, ShieldCheck, Sparkles, UploadCloud, Users,
} from 'lucide-react';

const sampleSummary = {
  totalClients: 1420,
  finalCkycUpdated: 752,
  requestIdUpdated: 510,
  recordsPending: 158,
  generatedRequests: 86,
  responsesUploaded: 64,
  lastImportFile: 'LMS_Client_Master_25Sep2026.xlsx',
  lastActivityAt: '2026-09-25T09:40:00.000Z',
  pendingErrors: [
    { name: 'Document number does not match CKYC records', count: 62 },
    { name: 'Date of birth requires correction', count: 41 },
    { name: 'Name details need review', count: 28 },
    { name: 'Additional information required', count: 27 },
  ],
};

const sampleRequests = [
  { id: 'sample-req-001', status: 'response_uploaded', fileName: 'CKYC_Search_S10021.xlsx', recordCount: 46, createdAt: '2026-09-25T09:30:00.000Z' },
  { id: 'sample-req-002', status: 'generated', fileName: 'CKYC_Search_S10020.xlsx', recordCount: 38, createdAt: '2026-09-24T15:10:00.000Z' },
  { id: 'sample-req-003', status: 'response_uploaded', fileName: 'CKYC_Search_S10019.xlsx', recordCount: 52, createdAt: '2026-09-24T11:25:00.000Z' },
];
...
export function OverviewSample({ mode = 'current' }: { mode?: 'current' | 'classic' }) {
  const summary = { data: sampleSummary, isError: false, isLoading: false, refetch: async () => undefined };
  const requests = { data: sampleRequests };
  const downloads = { data: [], isLoading: false };
  ...
  return (
    <div className={`animate-fade ckyc-typography-surface ${mode}`}>
